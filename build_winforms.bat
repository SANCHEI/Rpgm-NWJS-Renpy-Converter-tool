...
"%CSC%" /nologo /target:winexe /optimize+ /out:"%~dp0bin\GameAssetTool.exe" %ICON_FLAG% /reference:System.dll /reference:System.Core.dll /reference:System.Drawing.dll /reference:System.Windows.Forms.dll /reference:System.IO.Compression.dll "%~dp0Program.cs" "%~dp0RpgmvpConverterForm.cs" "%~dp0RpaExtractor.cs" "%~dp0UnlockerResources.cs"
