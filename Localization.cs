...
namespace RpgmvpConverterWinForms
{
    internal static class Loc
    {
        ...
        static Loc()
        {
            ...
            en["tab_rpgmvp"] = "RPGMVP";
            en["tab_rpa"] = "RPA Extract";
            en["tab_unlocker"] = "Unlocker";
            en["path_label"] = "Project folder";
            en["key_label"] = "HEX key";
            en["browse_btn"] = "Browse";
            en["game_root_btn"] = "Game Root";
            en["start_btn"] = "Start";
            en["pause_btn"] = "Pause";
            ...
            ru["tab_rpgmvp"] = "RPGMVP";
            ru["tab_rpa"] = "RPA Извлечение";
            ru["tab_unlocker"] = "Unlocker";
            ru["path_label"] = "Папка проекта";
            ru["key_label"] = "HEX-ключ";
            ru["browse_btn"] = "Обзор";
            ru["game_root_btn"] = "К корню игры";
            ru["start_btn"] = "Старт";
            ru["pause_btn"] = "Пауза";
