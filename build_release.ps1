...
$releaseExe = [IO.Path]::GetFullPath((Join-Path $release "GameAssetTool-v1.8.1.exe"))
...
foreach ($path in @($release, $releaseExe, $obsoleteCurrentPatchExe, $obsoletePreviousMinorExe, $obsoleteMinorExe, $obsoleteEarlierMinorExe, $obsoletePatchExe, $obsoletePreviousPatchExe, $obsoleteOlderPatchExe, $obsoleteReleaseExe, $obsoleteZip, $obj, $releaseBin)) {
